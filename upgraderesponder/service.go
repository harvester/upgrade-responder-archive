...
const (
	...
	InfluxDBDatabase            = "harvester_upgrade_responder"

	InfluxDBMeasurementName = "harvester_upgrade_query"
)

var (
	InfluxDBTagHarvesterVersion       = "harvester_version"
...
func (s *Server) recordRequest(httpReq *http.Request, req *CheckUpgradeRequest) {
	...
	if s.influxClient != nil {
		...
		tags := map[string]string{
			InfluxDBTagHarvesterVersion: req.HarvesterVersion,
		}
